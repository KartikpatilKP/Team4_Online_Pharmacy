...
function ManageDrugs() {
  ...
  const handleDelete = async (id) => {
    try {
      ...
      Swal.fire({
        icon: 'error',
        title: 'Delete failed',
        text: 'Could not delete medicine. Try again later.',
      });
    }
  };
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      await axios.put(
        `http://localhost:8080/api/medicines/${editingMedicine.id}`,
        editingMedicine,
    ...
    <div className="admin-dashboard-root">
      ...
      <main
        ...
        style={{
          ...
          width: `calc(100vw - ${collapsed ? 60 : 250}px)`,
        }}
      >
        <section>
          ...
          <div className="modal-content">
            ...
            <form onSubmit={handleUpdate}>
              ...
              <input
                ...
                value={editingMedicine.availableQuantity}
                onChange={handleEditChange}
                required
              />
              <input
